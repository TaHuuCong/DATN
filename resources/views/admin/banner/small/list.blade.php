...
<section class="content">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right: 0">
        <button type="button" class="pull-right btn btn-default addItem"><a href="{!! URL::route('admin.smallbanner.getAdd') !!}"> Thêm banner nhỏ</a></button>
    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#smallbanner").addClass('active');   //active sang cái mới
        var check = false;
