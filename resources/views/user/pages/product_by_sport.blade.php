...
<div class="main-content">
	<div class="container">
		<ul class="breadcrumb">
    		...
    		<li class="active">{{ $name_by_alias->name }}</li>
  		</ul><!-- /.breadcrumb -->
		...
		<div class="row">
					...
					<div class="product-sport">
						...
						<div class="name">
							<ul class="nav nav-pills nav-stacked">
								<li><a class="disabled-link">{{ $name_by_alias->name }}</a></li>
							</ul>
						</div>
					</div><!-- /.product-sport -->
			...
			<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
				<div class="newest-product">
					...
					@foreach ($prod_by_sport as $prod_by_sp)
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
						<div class="product-info text-center">
							<a href="#"><img src="{{ asset('resources/upload/images/product/small/'.$prod_by_sp->pr_id.'/'.$prod_by_sp->image) }}" /></a>
							...
							<h2>{{ $prod_by_sp->price }} VNĐ</h2>
							<a href=""><p>{{ $prod_by_sp->name }}</p></a>
